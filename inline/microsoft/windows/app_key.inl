...
static const unsigned char _app_key_from_key_code_map[] = {
    /* VK_LBUTTON             */ APP_KEY_MouseLeft,
    /* VK_RBUTTON             */ APP_KEY_MouseRight,
    /* VK_CANCEL              */ 0,
    /* VK_MBUTTON             */ APP_KEY_MouseMiddle,
    /* VK_XBUTTON1            */ APP_KEY_Mouse4,
    /* VK_XBUTTON2            */ APP_KEY_Mouse5,
    /* VK_0x07                */ 0,
    ...
    /* VK_PRINT               */ 0,
    /* VK_EXECUTE             */ 0,
    /* VK_SNAPSHOT            */ APP_KEY_PrintScreen,
    ...
    /* VK_0x5E                */ 0,
    /* VK_SLEEP               */ 0,
    /* VK_NUMPAD0             */ APP_KEY_Pad0,
    /* VK_NUMPAD1             */ APP_KEY_Pad1,
    /* VK_NUMPAD2             */ APP_KEY_Pad2,
    /* VK_NUMPAD3             */ APP_KEY_Pad3,
    /* VK_NUMPAD4             */ APP_KEY_Pad4,
    /* VK_NUMPAD5             */ APP_KEY_Pad5,
    /* VK_NUMPAD6             */ APP_KEY_Pad6,
    /* VK_NUMPAD7             */ APP_KEY_Pad7,
    /* VK_NUMPAD8             */ APP_KEY_Pad8,
    /* VK_NUMPAD9             */ APP_KEY_Pad9,
    /* VK_MULTIPLY            */ APP_KEY_PadMul,
    /* VK_ADD                 */ APP_KEY_PadAdd,
    /* VK_SEPARATOR           */ 0,
    /* VK_SUBTRACT            */ APP_KEY_PadSub,
    /* VK_DECIMAL             */ APP_KEY_PadDot,
    /* VK_DIVIDE              */ APP_KEY_PadDiv,
    /* VK_F1                  */ APP_KEY_F1,
    /* VK_F2                  */ APP_KEY_F2,
    /* VK_F3                  */ APP_KEY_F3,
    /* VK_F4                  */ APP_KEY_F4,
